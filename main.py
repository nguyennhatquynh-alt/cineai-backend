            ...
            <div id="drawer-script" class="fixed inset-0 bg-slate-950/80 backdrop-blur-md z-50 hidden flex flex-col justify-end p-2 sm:p-4">
                <div class="bg-slate-900 border border-slate-700 rounded-3xl p-4 sm:p-5 max-h-[85vh] overflow-y-auto space-y-3 shadow-2xl animate-in slide-in-from-bottom">
                    ...
                    <div>
                        ...
                        <input type="text" id="project-title" oninput="syncProjectTitleUI(this.value)" value="PROJECT_TITLE_VAL" class="w-full bg-slate-950 border border-slate-700 rounded-xl p-2.5 text-xs text-amber-300 font-bold">
                    </div>
                    <div>
...
def get_studio_javascript():
    return """
        <script>
            ...
            function syncProjectTitleUI(newVal) {
                currentProjectTitle = newVal.trim() || "Dự án mới";
            ...
            async function saveDraftCurrent(tier) {
                ...
                try {
                    ...
                    if(data.status === 'success') {
                        ...
                        syncProjectTitleUI(currentProjectTitle);
                    }
                } catch(e) {
                ...
                try {
                    ...
                    if (resData.status === 'success') {
                        ...
                        if(titleEl) {
                            ...
                            syncProjectTitleUI(resData.data.title);
                        }
